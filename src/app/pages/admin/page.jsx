...
const AdminPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.forEach((value, key) => {
      ...
      // const [lang, ...rest] = key.split("."); // Разделяем ключ на язык и остальные части
      // if (!translations[lang]) {
      //   translations[lang] = {};
      // }

      // Формируем структуру объекта для переводов
      // const nestedKey = rest.join(".");

      // Добавляем только непустые значения
      // if (value.trim() !== "") {
      //   translations[lang][nestedKey] = value;
      // }
    });
    ...
    // console.log(newAdminData);
    // Object.entries(newAdminData).forEach(([value, key]) => {
    //   const apart = value.split(".")
    //   const construct = apart.join(".")
    //   console.log("apart:", apart);
    //   console.log("construct:", construct);
    //   console.log( Object.entries(newAdminData));

    // });
    // console.log("Собранные данные:", translations); // Выводим собранные данные в консоль

    // Отправляем данные в API
    // console.log("JSON.:",JSON.stringify(newAdminData));
